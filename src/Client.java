...
public class Client implements MessagingApp {
                    ...
                    case 1:
                        ...
                        while (true) {
                            ...
                            try {
                                ...
                                messageCount++;
                                //if (messageCount < 100) {
                                //ClientMessages[messageCount++] = serverMessage;
                                //}
    ...
    /*@Override
    //public void viewConversation(Messages[] serverMessages) {
        for(int i = 1; i < ClientMessages.length;i++){
            System.out.println(ClientMessages[i].toString());
            for(int j = 1; j <= i; j++){
                System.out.println(serverMessages[j].toString());
            }
        }
    }*/
@Override
    public void sortMessages() {
        ...
        System.out.println("Messages sorted by timestamp.");
    }
@Override
